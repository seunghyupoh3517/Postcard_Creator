...
app.get("/", function (request, response) {
  response.sendFile(__dirname + '/public/fixed-postcard-creator.html');
});

//share postcards 누른 페이지
app.get("/fixed-postcard-display", function (request, response) {
  response.sendFile(__dirname + '/public/fixed-postcard-display.html');
});
//share 보냈을때 데이터 셋팅
